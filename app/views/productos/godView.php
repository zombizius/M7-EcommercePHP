         ...
         <div class="container">
             <div class="row top bottom left">
              ...
              <div class="col-8" id="info">
                ...
                <h1 class="precio">35€</h1>
                <form action=<?php echo $name ?> method="POST">
                <input type="number" value="8" name="idproducto" id="idproducto" style="display: none;">
                <input type="text" value="../views/img/pc/god/cover.jpg" name="linkimage" id="linkimage" style="display: none;">
                ...
                <div id="slidermenu">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a href=""><img src="../img/pc/god/slider1.jpg" class="d-block w-100" alt="Slider1"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
                        <div class="carousel-item">
                            <a href=""></a><img src="../img/pc/god/slider2.jpg" class="d-block w-100" alt="Slider2"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
                        <div class="carousel-item">
                            <a href=""></a><img src="../img/pc/god/slider3.jpg" class="d-block w-100" alt="Slider3"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
