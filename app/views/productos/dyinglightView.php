...
<body>
    <div class="container-fluid">
     ...
     <div class="container-fluid">
        <main class="top" id="dyinglight">	
         <div class="container">
             <div class="row top bottom left">

               <div class="col-12 col-sm-12 col-md-4 col-lg-4 cover">
                  <img src="../img/pc/dyinglight/cover.jpg" class="coverimg" alt="cover">
              </div>
              ...
              <div class="col-8" id="info">
                ...
                <p class="pwarning topmain">¡Quedan 27 en stock!</p>
                <h1 class="precio">7€</h1>
                ...
                <div id="slidermenu">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a href=""><img src="../img/pc/dyinglight/slider1.jpg" class="d-block w-100" alt="Slider1"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
                        <div class="carousel-item">
                            <a href=""></a><img src="../img/pc/dyinglight/slider2.jpg" class="d-block w-100" alt="Slider2"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
                        <div class="carousel-item">
                            <a href=""></a><img src="../img/pc/dyinglight/slider3.jpg" class="d-block w-100" alt="Slider3"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
