...
<body>
    <div class="container-fluid">
     ...
     <div class="container-fluid">
        <main class="top" id="farcry6">	
         <div class="container">
             <div class="row top bottom left">

               <div class="col-12 col-sm-12 col-md-4 col-lg-4 cover">
                  <img src="../img/pc/farcry6/cover.jpg" class="coverimg" alt="cover">
              </div>
              ...
              <div class="col-8" id="info">
                ...
                <p class="pwarning topmain">¡Quedan 200 en stock!</p>
                <h1 class="precio">42€</h1>
                <form action=<?php echo $name ?> method="POST">
                <input type="number" value="4" name="idproducto" id="idproducto" style="display: none;">
                <input type="text" value="../views/img/pc/farcry6/cover.jpg" name="linkimage" id="linkimage" style="display: none;">
                ...
                <div id="slidermenu">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a href=""><img src="../img/pc/farcry6/slider1.jpg" class="d-block w-100" alt="Slider1"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
                        <div class="carousel-item">
                            <a href=""></a><img src="../img/pc/farcry6/slider2.jpg" class="d-block w-100" alt="Slider2"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
                        <div class="carousel-item">
                            <a href=""></a><img src="../img/pc/farcry6/slider3.jpg" class="d-block w-100" alt="Slider3"></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="h5carousel"></h5>							
                            </div>
                        </div>
