							...
							<tbody>
								<tr>
									...
									while ($row = $query->fetch_assoc()) {
										...
										?>
										<td><img src="../<?php echo $row['image']; ?>" alt="Portada"></td>
										<td><?php echo $row['id']; ?></td>
										<td><?php echo $row['product']; ?></td>
										<td><?php echo $row['price']; ?></td>
										<td><?php echo $row['originalprice']; ?></td>										
										<td><a href="../<?php echo $row['link']; ?>" title="Título">Ir al Juego</a></td>
										<td>											
											<button class="btn"><img id="eliminarimg" src="img/eliminar.png"></button>				
										</td>										
									</tr>
								</tbody>
								<?php 
